...
async function getweather() {
  ...
  try {
    ...
    function geticon() {
      if (cityweather == "Rain") {
        bgimage.className =
          "h-screen w-full bg-[url('images/bg-image2.jpg')] bg-cover overflow-hidden";
        return "cloud-showers-heavy";
      } else if (cityweather == "Clouds") {
        bgimage.className =
          "h-screen w-full bg-[url('images/bg-image3.jpg')] bg-cover overflow-hidden";
        return "cloud";
      } else if (cityweather == "Clear") {
        bgimage.className =
          "h-screen w-full bg-[url('images/bg-image.jpg')] bg-cover overflow-hidden";
        return "sun";
      } else {
        bgimage.className =
          "h-screen w-full bg-[url('images/bg-image4.jpg')] bg-cover overflow-hidden";
        return "cloud";
      }
    }
